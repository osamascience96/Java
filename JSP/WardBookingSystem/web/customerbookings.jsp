...
<html>
    ...
    <%    
        ...
        ArrayList<Booking> arrayListBookings = (ArrayList<Booking>) session.getAttribute("customerbookinglist");
    %>
    <body>
        <div class="header">
                    ...
                    <%
                      if(arrayListBookings != null){
                        for(int i=0; i < arrayListBookings.size(); i++){
                            ...
                            out.println("<td>" + arrayListBookings.get(i).GetUserId()+ "</td>");
                            out.println("<td>" + arrayListBookings.get(i).GetWardId()+ "</td>");
                            out.println("<td>" + arrayListBookings.get(i).GetUsername()+ "</td>");
                            out.println("<td>" + arrayListBookings.get(i).GetWardName()+ "</td>");
                            out.println("<td>" + arrayListBookings.get(i).GetWardType()+ "</td>");
                            if(arrayListBookings.get(i).GetWardImage()!= null){
                                out.println("<td><img width='100px' height='100px' src='data:image/png;base64," + ImageBase64.GetImageData(arrayListBookings.get(i).GetWardImage()) + "'/></td>");
                            }else{
                                out.println("<td><img width='100px' height='100px' src='images/deluxroom.png'></td>");
                            }
                            out.println("<td>" + arrayListBookings.get(i).GetWardPrice()+ "</td>");
                            out.println("<td>" + arrayListBookings.get(i).GetPaymentStatus()+ "</td>");
                            out.println("<td>" + arrayListBookings.get(i).GetStatus()+ "</td>");
                            out.println("<td>" + arrayListBookings.get(i).GetCheckInDate()+ "</td>");
                            out.println("<td>" + arrayListBookings.get(i).GetCheckOutDate()+ "</td>");
                            out.println("<td><a href='customer-controller-servlet?customer-mode=edit-booking&booking_id="+arrayListBookings.get(i).GetBookingId()+"'>Edit</a></td>");
                            out.println("<td><a href='customer-controller-servlet?customer-mode=delete-book&booking_id="+arrayListBookings.get(i).GetBookingId()+"&ward_id="+arrayListBookings.get(i).GetWardId()+"'>Delete</a></td>");
                            out.println("</tr>");
                        }
                      }
                    %>
