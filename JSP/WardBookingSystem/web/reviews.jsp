...
<html>
    ...
    <%    
        ...
        ArrayList<Review> reviewsArrayList = (ArrayList<Review>) session.getAttribute("reviewscustomer");
    %>
    <body>
        <div class="header">
                  ...
                  <%
                      if(reviewsArrayList != null){
                        for(int i=0; i < reviewsArrayList.size(); i++){
                            out.println("<tr>");
                            out.println("<th scope='row'>" + reviewsArrayList.get(i).GetName()+ "</th>");
                            out.println("<td>"+ reviewsArrayList.get(i).GetPhone()+"</td>");
                            out.println("<td>"+ reviewsArrayList.get(i).GetEmail()+"</td>");
                            if(reviewsArrayList.get(i).GetImage()!= null){
                                out.println("<td><img width='100px' height='90px' src='data:image/png;base64,"+ ImageBase64.GetImageData(reviewsArrayList.get(i).GetImage()) +"'/></td>");
                            }else{
                                out.println("<td><img width='100px' height='90px' src='https://www.pavilionweb.com/wp-content/uploads/2017/03/man-300x300.png'/></td>");
                            }
                            out.println("<td>"+ reviewsArrayList.get(i).GetMessage()+"</td>");
                            out.println("</tr>");
                        }
                      }
                  %>
