...
<html>
    ...
    <%    
        ...
        ArrayList<Booking> bookingsArrayList = (ArrayList<Booking>) session.getAttribute("BookingList");
    %>
    <body>
        <div class="header">
        ...
        <div class="container">
            ...
            <table class="table">
                ...
                <tbody>
                  <%
                      if(bookingsArrayList != null){
                        for(int i=0; i < bookingsArrayList.size(); i++){
                            out.println("<tr>");
                            out.println("<th scope='row'>" + bookingsArrayList.get(i).GetBookingId() + "</th>");
                            out.println("<td>"+ bookingsArrayList.get(i).GetUserId() +"</td>");
                            out.println("<td>"+ bookingsArrayList.get(i).GetUsername() +"</td>");
                            out.println("<td>"+ bookingsArrayList.get(i).GetUserEmail() +"</td>");
                            if(bookingsArrayList.get(i).GetUserImage() != null){
                                out.println("<td><img width='100px' height='90px' src='data:image/png;base64,"+ ImageBase64.GetImageData(bookingsArrayList.get(i).GetUserImage()) +"'/></td>");
                            }else{
                                out.println("<td><img width='100px' height='90px' src='https://www.pavilionweb.com/wp-content/uploads/2017/03/man-300x300.png'/></td>");
                            }
                            out.println("<td>"+ bookingsArrayList.get(i).GetWardId()+"</td>");
                            out.println("<td>"+ bookingsArrayList.get(i).GetWardName()+"</td>");
                            out.println("<td>"+ bookingsArrayList.get(i).GetWardType()+"</td>");
                            if(bookingsArrayList.get(i).GetWardImage()!= null){
                                out.println("<td><img width='100px' height='90px' src='data:image/png;base64,"+ ImageBase64.GetImageData(bookingsArrayList.get(i).GetWardImage()) +"'/></td>");
                            }else{
                                out.println("<td><img width='100px' height='90px' src='images/deluxroom.png'/></td>");
                            }
                            out.println("<td>"+ bookingsArrayList.get(i).GetStatus()+"</td>");
                            out.println("<td>"+bookingsArrayList.get(i).GetPaymentStatus()+"</td>");
                            out.println("<td><a href='admin-controller-servlet?admin-mode=edit&edit_mode=booking&booking_id="+bookingsArrayList.get(i).GetBookingId()+"'>Edit</a></td>");
                            out.println("<td><a href='admin-controller-servlet?admin-mode=delete&del_mode=booking&current_module=todaybooking&booking="+bookingsArrayList.get(i).GetBookingId()+"&ward_id="+bookingsArrayList.get(i).GetWardId()+"'>Delete</a></td>");
                            out.println("</tr>");
                        }
                      }
                  %>
