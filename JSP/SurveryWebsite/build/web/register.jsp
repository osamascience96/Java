...
<body class="bg-gradient-primary">
    ...
    <div class="container">
                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            ...
                            <div class="user">
                                ...
                                <button onclick="register()" class="btn btn-primary btn-user btn-block">Register</button>
                            </div>
                            <hr>
                            <div class="text-center">
        ...
        <div id="register_alert_message"></div>
    ...
    <script src="js/userscript/register.js"></script>
