...
public class LoginFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
        ...
        if(username_email.compareTo(adminUsername) == 0 && password.compareTo(adminPassword) == 0){
            User userObj = new User();
            userObj.setUsername(adminUsername);
            userObj.setPassword(adminPassword);
            ...
            String json = new Gson().toJson("admin_login_success");
