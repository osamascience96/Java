  ...
  <body>
	...
	<div class="container">
		...
		<% if(arrayListAppointments != null){ %>
		             		...
		             		<tr>
		             			...
		             			<td class="text-center align-middle">
				                   <div class="btn-group align-top">
				                       <a class="btn btn-sm btn-outline-primary badge" type="button" href="AdminAppointment?statusupdate=true&id=<%=arrayListAppointments.get(i).getId()%>"><i class="fa fa-money" aria-hidden="true"></i></a>
				                       <a class="btn btn-sm btn-outline-danger badge" type="button" href="AdminAppointment?delrequest=true&id=<%=arrayListAppointments.get(i).getId()%>"><i class="fa fa-trash-o"></i></a>
				                   </div>	
				                </td>
		             		</tr>
		             	<% } %>
	        ...
	        <%} %>
        <% }%>
        <button class="btn btn-outline-primary btn-block" data-toggle="modal" data-target="#appointmentmodal">Add Appointment</button>
	</div>
