...
<html>
    <head>
        ...
        <!-- css page -->
        <link rel="stylesheet" type="text/css" href="css/wards.css">
    </head>
    <%
    ...
    <%    
        ...
        ArrayList<Ward> arrayListWards = (ArrayList<Ward>) session.getAttribute("wards");
    %>
    <body>
        <div class="header">
        ...
        <div class="container">
            ...
            <table class="table">
                ...
                <tbody>
                    <%
                      if(arrayListWards != null){
                        for(int i=0; i < arrayListWards.size(); i++){
                            out.println("<tr>");
                            out.println("<th scope='row'>" + arrayListWards.get(i).GetId() + "</th>");
                            out.println("<td>" + arrayListWards.get(i).GetName() + "</td>");
                            out.println("<td>" + arrayListWards.get(i).GetType() + "</td>");
                            out.println("<td>" + arrayListWards.get(i).GetStatus()+ "</td>");
                            if(arrayListWards.get(i).GetImage() != null){
                                out.println("<td><img width='100px' height='100px' src='data:image/png;base64," + ImageBase64.GetImageData(arrayListWards.get(i).GetImage()) + "'/></td>");
                            }else{
                                out.println("<td><img width='100px' height='100px' src='images/deluxroom.png'></td>");
                            }
                            out.println("<td>" + arrayListWards.get(i).GetPrice()+ "</td>");
                            out.println("<td>" + arrayListWards.get(i).GetDate() + "</td>");
                            out.println("<td>" + arrayListWards.get(i).GetTime()+ "</td>");
                            out.println("<td><a href='admin-controller-servlet?admin-mode=edit&edit_mode=wards&ward="+arrayListWards.get(i).GetId()+"'>Edit</a></td>");
                            out.println("<td><a href='admin-controller-servlet?admin-mode=delete&del_mode=wards&current_module=wards&ward="+arrayListWards.get(i).GetId()+"'>Delete</a></td>");
                            out.println("</tr>");
                        }
                      }
                    %>
