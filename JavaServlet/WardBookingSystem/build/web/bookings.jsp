...
<html>
    ...
    <%    
        ...
        ArrayList<Booking> arrayListBookings = (ArrayList<Booking>) session.getAttribute("bookings");
    %>
    <body>
        <div class="header">
        ...
        <div class="container">
            ...
            <table class="table">
                ...
                <tbody>
                    <%
                      if(arrayListBookings != null){
                        for(int i=0; i < arrayListBookings.size(); i++){
                            out.println("<tr>");
                            out.println("<th scope='row'>" + arrayListBookings.get(i).GetBookingId()+ "</th>");
                            out.println("<th>" + arrayListBookings.get(i).GetUserId() + "</th>");
                            out.println("<th>" + arrayListBookings.get(i).GetUsername() + "</th>");
                            out.println("<th>" + arrayListBookings.get(i).GetUserEmail() + "</th>");
                            if(arrayListBookings.get(i).GetUserImage() != null){
                                out.println("<td><img width='100px' height='90px' src='data:image/png;base64,"+ ImageBase64.GetImageData(arrayListBookings.get(i).GetUserImage()) +"'/></td>");
                            }else{
                                out.println("<td><img width='100px' height='90px' src='https://www.pavilionweb.com/wp-content/uploads/2017/03/man-300x300.png'/></td>");
                            }
                            out.println("<th>" + arrayListBookings.get(i).GetWardId()+ "</th>");
                            out.println("<th>" + arrayListBookings.get(i).GetWardName()+ "</th>");
                            out.println("<th>" + arrayListBookings.get(i).GetWardType()+ "</th>");
                            if(arrayListBookings.get(i).GetWardImage() != null){
                                out.println("<td><img width='100px' height='90px' src='data:image/png;base64,"+ ImageBase64.GetImageData(arrayListBookings.get(i).GetWardImage()) +"'/></td>");
                            }else{
                                out.println("<td><img width='100px' height='90px' src='images/deluxroom.png'/></td>");
                            }
                            out.println("<th>"+arrayListBookings.get(i).GetPaymentStatus()+"</th>");
                            out.println("<th>" + arrayListBookings.get(i).GetStatus()+ "</th>");
                            out.println("<th>" + arrayListBookings.get(i).GetDate()+ "</th>");
                            out.println("<td><a href='admin-controller-servlet?admin-mode=edit&edit_mode=booking&booking_id="+arrayListBookings.get(i).GetBookingId()+"'>Edit</a></td>");
                            out.println("<td><a href='admin-controller-servlet?admin-mode=delete&del_mode=booking&current_module=allbookigs&booking="+arrayListBookings.get(i).GetBookingId()+"&ward_id="+arrayListBookings.get(i).GetWardId()+"'>Delete</a></td>");
                            out.println("</tr>");
                        }
                      }
                    %>
